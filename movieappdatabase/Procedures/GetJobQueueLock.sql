-- PROCEDURE: public.GetJobQueueLock(character varying, boolean)

-- DROP PROCEDURE public."GetJobQueueLock"(character varying, boolean);
...
DO $$ BEGIN
    ...
    THEN
        CREATE PROCEDURE public."GetJobQueueLock"(
